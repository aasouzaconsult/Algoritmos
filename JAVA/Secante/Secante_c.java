        	...
        	for ( int k = 2 ; k <= n+1 ; k++ )
	  		{
            	...
            	x[1]=v2;  // Entrada do Algoritmo
               	...
               	// Calculo das funções (x0 e x1) - Derivada 1º 4x^3 - 3x^2 -2x
            	f1x[0]= (4*(x[0]*x[0]*x[0])) - (3*(x[0]*x[0])) - (2*x[0]);
            	f1x[1]= (4*(x[1]*x[1]*x[1])) - (3*(x[1]*x[1])) - (2*x[1]);
            	...
            	// Calculo das funções - Derivada 1º -> 4x^3 - 3x^2 -2x 
