...
//com colocação ordenada no vector
//
//Alternativa utilizando System.arraycopy
//
class TesteArrays3B{
	...
	public static void main(String args[]) throws java.io.IOException
	{
		...
		while (n!=0) {
			...
			int j=0;
			int newpos=0;
			while(j<n1.length && n>n1[j]) {
				newpos = j+1;
			}
			//copiar valores
			System.arraycopy(n1,0,n2,0,newpos);
			System.arraycopy(n1,newpos,n2,newpos+1,n1.length-newpos);
