/* Utilizar para adicionar primeiro utilize o botão Limpa Cadastro e depois
preencha com os dados e Clique no Botão Adicionar.
   Para Remover é só clicar no botão remover.
   Para navegar entre os registros clique no botão Próximo.
