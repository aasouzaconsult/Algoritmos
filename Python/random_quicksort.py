...
def random_quicksort(a_list, start, end):
    if start < end:
        pivot = random_partition(a_list, start, end)
        random_quicksort(a_list, start, pivot-1)
        random_quicksort(a_list, pivot+1, end)
    return a_list
...
if __name__ == "__main__":
    ...
    print random_quicksort(test_list, 0, len(test_list)-1)
    print random_quicksort(test_list2, 0, len(test_list2)-1)
