...
def quicksort(array):
    ...
    element. Then we merge the 2 sublists by placing pivot element in between.
    We recursively sort the sublists until no elements are left in partition.
...
def partition(array, low, high):
    ...
    #       swap current element with first high index
    #       increment first high index
    # swap pivot element and first high index
